...
function statisticsHandler(criteria, value, survey, survey_category,indicator_type) {
    ...
    //Section 6 MNH
    loadGraph(base_url, 'c_analytics/getMNHEquipmentFrequency/' + criteria + '/' + value + '/' + survey + '/' + survey_category , '#MNHequipment_availability');
    loadGraph(base_url, 'c_analytics/getMNHEquipmentLocation/' + criteria + '/' + value + '/' + survey + '/' + survey_category , '#MNHequipment_location');
    loadGraph(base_url, 'c_analytics/getMNHEquipmentFunctionality/' + criteria + '/' + value + '/' + survey + '/' + survey_category , '#MNHequipment_functionality');
