...
class MY_Controller extends CI_Controller
{
    ...
    public function createWorkProfileSection() {
        ...
        foreach ($this->data_found as $value) {
            ...
            <td >
            <label for="Yes" style="font-weight:normal">Yes</label>
            ...
            <td >' . $value['questionName'] . '</td>
            <td >
            <label for="County" style="font-weight:normal">County</label>
            <input type="text" name="questionResponseYes_' . $counter . '[]" id="questionResponseYes_' . $counter . '" class="cloned"/>
           </td>
            <input type="hidden"  name="questionCode_' . $counter . '" id="questionCode_' . $counter . '" value="' . $value['questionCode'] . '" />
        </tr>';
                $this->hcwWorkProfile.= $data;
            ...
            <label for="County and Facility" style="font-weight:normal">County and Facility</label>
             <input type="text" name="questionResponseNo_' . $counter . '[]" id="questionResponseNo_' . $counter . '" class="cloned"/>
    ...
    public function createmchConsultationSection(){
        ...
        foreach ($this->data_found as $value) {
            ...
            <td colspan="1">(<strong>' . $counter . '</strong>) ' . $value['questionName'] . '</td>
            <td colspan="1">
            <select name="healthResponse_' . $counter . '" id="healthResponse_' . $counter . '" class="cloned is-guideline">
                <option value="" selected="selected">Select One</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            ...
            <input type="hidden"  name="healthResponseCode_' . $counter . '" id="healthResponseCode_' . $counter . '" value="' . $value['questionCode'] . '" />
        </tr>';
        }
            ...
            if ($section != 'sgn' && $section != 'svc' && $section != 'ror' && $section != 'tl') {
                if ($value['indicatorFindings'] != null) {
                    ...
                    if (sizeof($findings) == 1) {
                        foreach ($findings as $finding1) {
                            $findingHCWRow = $finding1 . ' <input type="text" name="indicatorhcwFindings_' . $counter . '" id="indicatorhcwFindings_' . $counter . '">';
                            $findingAssessorRow = $finding1 . ' <input type="text" name="indicatorassessorFindings_' . $counter . '" id="indicatorassessorFindings_' . $counter . '">';
                        }
                    } else {
                        $findingHCWRow = $findingAssessorRow='';
                        foreach ($findings as $finding) {
                            ...
                            if ($finding == 'other (specify)') {
                                $findingHCWRow.= $finding . ' <input name="indicatorhcwFinding_' . $counter . '" id="indicatorhcwFindings_' . $counter . '"  type="text">';
...
//over here
    ...
    public function createStaffTrainingGuidelinesSection() {
        ...
        $this->trainingGuidelineSection[1] = $this->trainingGuidelineSection[2] = "";
    ...
    <option value = "malTreatment_0" id = "not_selected">Select a treatment</option>';
        ...
        foreach ($this->data_found as $value) {
            $counter++;
            if ($value['treatmentName'] != 'Others') {
                $this->mchmalariaTreatmentSection.= '<option value = "' . $value['treatmentCode'] . '" id = "malTreatment_' . $counter . '">' . $value['treatmentName'] . '</option>';
            }
        }
...
<option value = "pneTreatment_0" id = "not_selected">Select a treatment</option>';
        ...
        foreach ($this->data_found as $value) {
            $counter++;
            if ($value['treatmentName'] != 'Others') {
                $this->mchpneumoniaTreatmentSection.= '<option value = "' . $value['treatmentCode'] . '" id = "pneTreatment_' . $counter . '">' . $value['treatmentName'] . '</option>';
            }
        }
    ...
    /**
     * [createDiarrhoeaTreatmentTSection description]
     * @return [type] [description]
     */
    public function createDiarrhoeaTreatmentTSection() {
        ...
        foreach ($this->data_found as $value) {
            $counter++;
            if ($value['treatmentName'] != 'Others') {
                $this->treatmentMCHSection.= '<option value = "' . $value['treatmentCode'] . '" id = "diaTreatment_' . $counter . '">' . $value['treatmentName'] . '</option>';
            }
        }
