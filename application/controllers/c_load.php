...
<table>
 ...
 <table >
    ...
    <tbody>
        <tr>
            <td>Name </td><td>
            <input type="text" size="40" name = "assesorname_1" class="cloned">
            </td><td>Designation </td><td><!--input type="text" id="designation" name="designation" class="cloned"  size="40"/-->
            <input type="text" size="40" name = "assesordesignation_1" class="cloned">
            </td><td>Email </td>
            <td>
            <input type="text" size="40" name = "assesoremail_1" class="cloned">
            </td>
            </td><td>Phone Number </td>
            <td>
            <input type="text" size="40" name = "assesorphoneNumber_1" class="cloned">
            </td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <input type="email" size="40" name = "assesoremail_1" class="cloned" >
            </td>
            </td><td>Phone Number </td>
            <td>
            <input type="text" size="40" name = "assesorphoneNumber_1" class="phone cloned" >
            </td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>First Name</td>
            <td><input type="text" name="hpfirstname_1" id="hpfirstname" class="cloned" ></td>
            <td>Surname</td>
            <td><input type="text" name="hpsurname_1" id="hpsurname" class="cloned" ></td>
        </tr>
        <tr>
            <td>National ID</td>
            <td><input type="text" name="hpnationalid_1" id="hpnationalid" class="cloned" ></td>
            <td>Phone Number</td>
            <td><input type="text" name="hpphonenumber_1" id="hpphonenumber" class="cloned" ></td>
        </tr>
        <tr>
            <td colspan="1">Year, Month when trained <input type="text" name="hpyear_1" id="hpyear" class="cloned" ></td>
            <td colspan="3"><p><b>Key coordinator of the training(Select one)</b></p>
                <p><input type="radio" name="hpcoordinator_1" value="MOH/KPA/CHAI" class="cloned" >MOH/KPA/CHAI</p>
                <p><input type="radio" name="hpcoordinator_1" value="MOH only" class="cloned" >MOH only</p>
                <p><input type="radio" name="hpcoordinator_1" value="Other" class="cloned" >Other</p>
                <p>(If other, indicate the name of the coordinator/partner)<input type="text" name="hpother" id="hp_other" class="cloned" style="display:none" ></p>
            </td>
        </tr>
        <tr>
            <td colspan="1"><label for="">Designation</label></td>
            <td colspan="3"><input type="text" name="hpdesignation_1" id="hpdesignation" class="cloned" ></td>
...
<thead>
    ...
    <tr>
        <td>
            <input type="radio" name="questionAspectResponse_1" value="Fully Practicing IMCI" class="cloned" >	Fully Practicing IMCI
        </td>
        <td>
        </td>
    </tr>
    <tr>
        <td>
            <input type="radio" name="questionAspectResponse_1" value="Practicing with gaps" class="cloned" >	Practicing with gaps
        </td>
        <td>
    ...
    <tr>
        <td>
           	<input type="radio" name="questionAspectResponse_1" value="Not practicing at all" class="cloned" >	Not practicing at all
        </td>
         <td>
            Reason <input type="text" size="100">
        </td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><textarea name="hcwConclusionActionSupervisor_1" style="width:400px;height:100px" class="cloned" ></textarea></td>
            <td><textarea name="hcwConclusionActionSupervisee_1" style="width:400px;height:100px" class="cloned" ></textarea></td>
        </tr>
        <tr>
            <td>Supervisor Signature<input name="hcwConclusionSignatureSupervisor_1" type="text" style="width:500px;padding:10px" class="cloned" ></td>
            <td>Supervisee Signature<input name="hcwConclusionSignatureSupervisee_1" type="text" style="width:500px;padding:10px" class="cloned" ></td>
        </tr>
        <tr>
            <td>Date	<input type="text" name="hcwConclusionDateSupervisor_1" style="width:500px;padding:10px" class="cloned" ></td>
            <td>Date	<input type="text" name="hcwConclusionDateSupervisee_1" style="width:500px;padding:10px" class="cloned" ></td>
        </tr>
    </tbody>
