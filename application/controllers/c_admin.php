...
<body>
  <table class="body">
    ...
    public function send_email($message) {
        ...
        isset($cc_email) ? $this->email->cc($cc_email) : (isset($bcc_email)) ? $this->email->bcc($mail_list . $bcc_email) : $this->email->bcc(substr($mail_list, 0, -1));
        
        (isset($attach_file)) ? $this->email->attach($attach_file) : '';
        
        $this->email->subject($subject);
        $this->email->message($this->create_mail($message));
