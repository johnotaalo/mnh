				...
				function renderFacilityInfo(){
    			 $.ajax({
		            type: "GET",
						...
						$("#inchargename").val(facility.facilityInchargeContactPerson);
						$("#inchargemobile").val(facility.facilityInchargeContactPerson);
						$("#inchargeemail").val(facility.facilityInchargeContactPerson);
						
						$("#mchname").val(facility.facilityInchargeContactPerson);
						$("#mchmobile").val(facility.facilityInchargeContactPerson);
						$("#mchemail").val(facility.facilityInchargeContactPerson);
						
						$("#maternityname").val(facility.facilityInchargeContactPerson);
						$("#maternitymobile").val(facility.facilityInchargeContactPerson);
						$("#maternityemail").val(facility.facilityInchargeContactPerson);
