                ...
                <div class="tile map-info" id="map-info">
                    ...
                    <div class="outer">
                       <div class="statistic"><div class="icon"><span><i class="fa fa-map-marker"></i></span></div><div class="data"><span class="text" id="county_name">No County Chosen</span></div></div>
                        ...
                        <div class="statistic"><div class="icon"><span><i class="fa fa-hospital-o"></i></span></div><div class="data" id="county_progress"><span class="text">Reporting Progress</span><span class="digit"><div class = "progress" style = "width: 300px;"><div class = "progress-bar" aria-valuenow = "0" aria-valuemax = "100" >0%</div></div></span></div></div>
