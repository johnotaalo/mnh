...
class M_MNH_Survey extends MY_Model
{
    ...
    public function verifyRespondedByDistrict() {
        if ($this->input->post()) {
            ...
            try {
                $this->district = $this->em->getRepository('models\Entities\Districts')->findOneBy(array('districtId' => $this->input->post('district', TRUE), 'districtAccessCode' => md5($this->input->post('usercode', TRUE))));
