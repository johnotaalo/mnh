 ...
 * LogSupplyStockOuts
 *
 * @Table(name="log_supply_stock_outs")
 * @Entity
 */
class LogSupplyStockOuts
{
     ...
     * @var integer
     *
     * @Column(name="lsso_id", type="integer", nullable=false)
     * @Id
     ...
     * @var integer
     *
     * @Column(name="lsso_usage", type="integer", nullable=false)
     */
    private $lssoUsage;
     ...
     * @var string
     *
     * @Column(name="lsso_unavailable_times", type="string", length=55, nullable=false)
     */
     ...
     * @var string
     *
     * @Column(name="lsso_option_on_outage", type="string", length=25, nullable=true)
     */
     ...
     * @var string
     *
     * @Column(name="fac_mfl", type="string", length=55, nullable=false)
     */
    private $facMfl;
