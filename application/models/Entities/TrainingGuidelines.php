 ...
 * TrainingGuidelines
 *
 * @Table(name="training_guidelines")
 * @Entity
 */
class TrainingGuidelines
{
     ...
     * @var integer
     *
     * @Column(name="tg_trained_after_2010", type="integer", nullable=false)
     */
     ...
     * @var integer
     *
     * @Column(name="tg_trained_before_2010", type="integer", nullable=false)
     */
     ...
     * @var integer
     *
     * @Column(name="tg_working", type="integer", nullable=false)
     */
    private $tgWorking;
     ...
     * @var \DateTime
     *
     * @Column(name="tg_created", type="datetime", nullable=false)
     */
    private $tgCreated;
     ...
     * @var integer
     *
     * @Column(name="fac_mfl", type="integer", nullable=false)
     */
    private $facMfl;
     ...
     * @var string
     *
     * @Column(name="guide_code", type="string", length=11, nullable=false)
     */
    private $guideCode;
