...
class HcwProfile
{
     ...
     * @var integer
     *
     * @Column(name="hp_id", type="integer", nullable=false)
     * @Id
     ...
     * @var string
     *
     * @Column(name="hp_firstName", type="string", length=400, nullable=true)
     */
    private $hpFirstname;
     ...
     * @var string
     *
     * @Column(name="hp_surname", type="string", length=400, nullable=true)
     */
    private $hpSurname;
     ...
     * @var string
     *
     * @Column(name="hp_nationalID", type="string", length=255, nullable=true)
     */
     ...
     * @var integer
     *
     * @Column(name="hp_phoneNumber", type="integer", nullable=true)
     */
     ...
     * @var string
     *
     * @Column(name="hp_coordinator", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @Column(name="hp_year", type="string", length=9, nullable=true)
     */
    private $hpYear;
     ...
     * @var string
     *
     * @Column(name="hp_designation", type="string", length=255, nullable=true)
     */
