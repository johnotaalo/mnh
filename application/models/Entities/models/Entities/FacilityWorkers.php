 ...
 * FacilityWorkers
 *
 * @ORM\Table(name="facility_workers")
 * @ORM\Entity
 */
class FacilityWorkers
{
     ...
     * @var integer
     *
     * @ORM\Column(name="fw_id", type="integer", nullable=false)
     * @ORM\Id
     ...
     * @var string
     *
     * @ORM\Column(name="fw_first_name", type="string", length=45, nullable=true)
     */
    private $fwFirstName;
     ...
     * @var string
     *
     * @ORM\Column(name="fw_last_name", type="string", length=45, nullable=true)
     */
    private $fwLastName;
     ...
     * @var string
     *
     * @ORM\Column(name="fw_national_id", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fw_personel_id", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fw_phone_number", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fw_year_month_trained", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fw_coordinator", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fw_designation", type="string", length=45, nullable=true)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="fw_updated", type="datetime", nullable=true)
     */
    private $fwUpdated;
