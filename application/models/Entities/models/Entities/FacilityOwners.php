...
class FacilityOwners
{
     ...
     * @var string
     *
     * @ORM\Column(name="fo_name", type="string", length=255, nullable=false)
     */
    private $foName;
     ...
     * @var string
     *
     * @ORM\Column(name="fo_for", type="string", length=3, nullable=false)
     */
    private $foFor;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="fo_created", type="datetime", nullable=false)
     */
    private $foCreated;
