...
class SurveyStatus
{
     ...
     * @var integer
     *
     * @Column(name="ss_id", type="integer", nullable=false)
     * @Id
     ...
     * @var string
     *
     * @Column(name="ss_classification", type="string", length=45, nullable=true)
     */
     ...
     * @var string
     *
     * @Column(name="ss_year", type="string", length=45, nullable=true)
     */
    private $ssYear;
     ...
     * @var integer
     *
     * @Column(name="fac_id", type="integer", nullable=true)
     */
    private $facId;
     ...
     * @var integer
     *
     * @Column(name="st_id", type="integer", nullable=true)
     */
    private $stId;
     ...
     * @var integer
     *
     * @Column(name="sc_id", type="integer", nullable=true)
     */
    private $scId;
