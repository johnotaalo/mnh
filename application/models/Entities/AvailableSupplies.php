...
class AvailableSupplies
{
     ...
     * @var integer
     *
     * @Column(name="as_id", type="integer", nullable=false)
     * @Id
     ...
     * @var string
     *
     * @Column(name="as_availability", type="string", length=45, nullable=false)
     */
     ...
     * @var string
     *
     * @Column(name="as_location", type="string", length=255, nullable=false)
     */
    private $asLocation;
     ...
     * @var integer
     *
     * @Column(name="as_quantity", type="integer", nullable=true)
     */
    private $asQuantity;
     ...
     * @var string
     *
     * @Column(name="as_reason_unavailable", type="string", length=45, nullable=true)
     */
     ...
     * @var \DateTime
     *
     * @Column(name="as_created", type="datetime", nullable=false)
     */
    private $asCreated;
