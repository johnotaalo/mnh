...
class LogQuestions
{
     ...
     * @var string
     *
     * @Column(name="lq_reason", type="string", length=200, nullable=false)
     */
    private $lqReason;
     ...
     * @var string
     *
     * @Column(name="lq_specified_or_follow_up", type="string", length=255, nullable=false)
     */
