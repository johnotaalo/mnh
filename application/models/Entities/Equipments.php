...
class Equipments
{
     ...
     * @var integer
     *
     * @Column(name="eq_id", type="integer", nullable=false)
     * @Id
     ...
     * @var string
     *
     * @Column(name="eq_name", type="string", length=100, nullable=false)
     */
    private $eqName;
     ...
     * @var string
     *
     * @Column(name="eq_unit", type="string", length=22, nullable=false)
     */
    private $eqUnit;
     ...
     * @var string
     *
     * @Column(name="eq_for", type="string", length=3, nullable=false)
     */
    private $eqFor;
