 ...
 private function addIndicatorInfo() {
    ...
    private function addBundling() {
        ...
        for ($i = 1; $i <= $this->noOfInsertsBatch + 1; ++$i) {
            ...
            $this->theForm->setFacMfl($this->session->userdata('facilityMFL'));
            $this->theForm->setCommCode($this->elements[$i]['cqCommodityCode']);
                    ...
                    if ($this->sectionExists == false) {
                        if (
                         /*$this->updateFacilityInfo()	==	true &&*/
                          $this->addmchConsultationQuestions() == true && $this->addMchAssessorInfo() == true) {
                        	//$this->addMchHealthServiceQuestion() == true ){	
                        	//Defined in MY_Model
